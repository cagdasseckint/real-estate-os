...
const DEFAULTS = {
  ...
  GMAIL_SCAN_THREAD_LIMIT: 50,
  GMAIL_SCAN_DAYS_LOOKBACK: 30,
  DASHBOARD_AUTO_REFRESH: true,
  DASHBOARD_SUMMARY_ENABLED: true,
  DASHBOARD_CHARTS_ENABLED: true,
  DASHBOARD_UNIFIED_INCREMENTAL: true,
  DASHBOARD_UNIFIED_MAX_ROWS: 500,
  ...
  MODULES_OPEN_HOUSE_ENABLED: false,
  MODULES_PROFILES_ENABLED: false,
  MODULES_TIMESHEET_ENABLED: false,
  MODULES_LEDGER_ENABLED: false,
  MODULES_CLOSING_COSTS_ENABLED: false,
  MODULES_LISTING_EXPENSES_ENABLED: false,
  MODULES_INVESTMENT_ENABLED: false,
  MODULES_MORTGAGE_ENABLED: false,
  MODULES_DOCS_BILLING_ENABLED: false,
  MODULES_PROJECTS_ENABLED: false,
  MODULES_UI_VALIDATION_ENABLED: false,
  MODULES_ROLE_VIEWS_ENABLED: false
};
