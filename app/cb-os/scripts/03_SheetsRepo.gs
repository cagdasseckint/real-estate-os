...
function seedDefaultConfig_() {
  ...
  const defaults = [
    ...
    ['MAX_PAYLOAD_SIZE_KB', DEFAULTS.MAX_PAYLOAD_SIZE_KB, 'Maximum payload size in KB for INGEST_QUEUE items'],
    ['GMAIL_SCAN_THREAD_LIMIT', DEFAULTS.GMAIL_SCAN_THREAD_LIMIT, 'Max Gmail threads to scan per label'],
    ['GMAIL_SCAN_DAYS_LOOKBACK', DEFAULTS.GMAIL_SCAN_DAYS_LOOKBACK, 'Lookback window (days) for Gmail scans'],
    ['DASHBOARD_AUTO_REFRESH', DEFAULTS.DASHBOARD_AUTO_REFRESH, 'Enable automated dashboard refresh in guardrails job'],
    ['DASHBOARD_SUMMARY_ENABLED', DEFAULTS.DASHBOARD_SUMMARY_ENABLED, 'Enable dashboard summary refresh'],
    ['DASHBOARD_CHARTS_ENABLED', DEFAULTS.DASHBOARD_CHARTS_ENABLED, 'Enable dashboard charts refresh'],
    ['DASHBOARD_UNIFIED_INCREMENTAL', DEFAULTS.DASHBOARD_UNIFIED_INCREMENTAL, 'Enable incremental unified table refresh'],
    ['DASHBOARD_UNIFIED_MAX_ROWS', DEFAULTS.DASHBOARD_UNIFIED_MAX_ROWS, 'Max unified rows per incremental refresh'],
